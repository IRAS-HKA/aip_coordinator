 ...
 */
std::string VizCloseGripper::ros2_service_name()
{
    return "/viz_close_gripper";
}
 ...
 */
BT::PortsList VizCloseGripper::providedPorts()
{
    return {
 ...
 */
void VizCloseGripper::on_send(std::shared_ptr<VizCloseGripperSrv::Request> request)
{
    ...
    log("Requesting Close Gripper for object_no" + std::to_string(object_no) + "with Length of call " + std::to_string(request->cylinders.cylinder_ids.size()));
 ...
 */
bool VizCloseGripper::on_result(std::shared_ptr<VizCloseGripperSrv::Response>, std::shared_ptr<VizCloseGripperSrv::Request>)
{
