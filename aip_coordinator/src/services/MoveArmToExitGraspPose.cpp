 ...
 */
std::string MoveArmToExitGraspPose::ros2_service_name()
{
    return "/move_to_pose";
}
 ...
 */
BT::PortsList MoveArmToExitGraspPose::providedPorts()
{
    return {
 ...
 */
void MoveArmToExitGraspPose::on_send(std::shared_ptr<MoveArmToExitGraspPoseSrv::Request> request)
{
    ...
    log("Requesting MoveArmToExitGraspPose for object_no" + std::to_string(object_no));
 ...
 */
bool MoveArmToExitGraspPose::on_result(std::shared_ptr<MoveArmToExitGraspPoseSrv::Response>, std::shared_ptr<MoveArmToExitGraspPoseSrv::Request>)
{
    log("MoveArmToExitGraspPoseSrv completed");
    return true;
}