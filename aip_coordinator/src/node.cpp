...
// Conditions
#include <aip_coordinator/conditions/CheckStop.h>
#include <aip_coordinator/conditions/CheckBattery.h>
#include <aip_coordinator/conditions/CheckDiagnosticStatus.h>
#include <aip_coordinator/conditions/CheckBlackboard.h>
#include <aip_coordinator/conditions/CheckBlackboardInt.h>

// User Input
#include <aip_coordinator/services/ParameterRequest.h>
...
#include <aip_coordinator/services/ClearGlobalCostmap.h>
#include <aip_coordinator/services/ClearLocalCostmap.h>
#include <aip_coordinator/nodes/SetInitialPose.h>
...
BT::Tree create_tree(const std::string &main_tree_path, const std::string &groot_palette_path)
{
    ...
    factory.registerNodeType<DeleteParameters>("DeleteParameters");
